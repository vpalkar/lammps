...
#ifdef FIX_CLASS
// clang-format off
FixStyle(bond/break/edpd,FixBondBreakEdpd);
// clang-format on
#else

#ifndef LMP_FIX_BOND_BREAK_EDPD_H
#define LMP_FIX_BOND_BREAK_EDPD_H

#include "fix.h"

namespace LAMMPS_NS {

class FixBondBreakEdpd : public Fix {
  friend class FixSRPREACT;
 public:
  FixBondBreakEdpd(class LAMMPS *, int, char **);
  ~FixBondBreakEdpd() override;
